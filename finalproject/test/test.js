...
contract('marketplace test', async (accounts) => {
	...
	it("should buy product and decrement quantity", async () => {
		let ins = await marketplace.deployed();
		
		var acc = accounts[1];
		let id = await ins.newProduct.call("testid",web3.toWei(3500, "finney"),5);
        assert.equal(id.valueOf(), "0x4b622b86e78c8e4f741ba1b74c587b54effcf7e44ba90876e00bb845ca741530");
		
		//await ins.buy({from: acc, value: web3.toWei(7000, "finney")},"0x4b622b86e78c8e4f741ba1b74c587b54effcf7e44ba90876e00bb845ca741530",1);
					 
		//let prductquantity = await ins.getproduct.call("0x4b622b86e78c8e4f741ba1b74c587b54effcf7e44ba90876e00bb845ca741530");


		//assert.equal(prductquantity[2], 4);
	})
